<nav class="navbar navbar-inverse navbar-light bg-light p-3 border">
  <div class="d-flex col-12 col-md-3 col-lg-2 mb-2 mb-lg-0 justify-content-between">
    <a class="navbar-brand" href="dashboard.php"><strong>LifeHub</strong> Admin</a>
    ...
    <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse border-right pt-3">
      <div class="position-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
                <a class="nav-link" href="dashboard.php"><i class="fa fa-regular fa-clipboard" style="margin-right: 20px;"></i> Dashboard</a>
            </li>


          <li class="nav-item">
                <a class="nav-link" href="" data-bs-toggle="collapse" data-bs-target="#demo"><i class="fa fa-regular fa-user" style="margin-right: 20px;"></i></i> Users <i class="fa fa-fw fa-caret-down"></i></a>
                <ul id="demo" class="">
                    <li class="list-unstyled">
                        <a class="nav-link" href="users.php"><i class="fa fa-regular fa-eye" style="margin-right: 20px;"></i> View All Users</a>
                    </li>
                    <li class="list-unstyled">
                        <a class="nav-link" href="users.php?source=add_user"><i class="fa fa-solid fa-plus" style="margin-right: 20px;"></i> Add User</a>
                    </li>
                </ul>
            </li>
